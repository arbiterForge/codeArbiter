...
2. **Conflict-resolution hierarchy attempt.** Walk CLAUDE.md §1 levels in order. Identify the level at which the conflict resolves, OR state that it does not resolve within the hierarchy.
