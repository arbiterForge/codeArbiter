...
1. File + line number cited? (yes/no)
2. Specific rule cited — not "best practices" or "good practice"? (yes/no)
3. Fix is testable — an observer can verify it was done? (yes/no)
...
Document each QUALITY-UNCERTAIN report at the top of the triage output before the de-duplication table.
...
| Reviewer | File+Line Cited | Specific Rule | Testable Fix | Quality Status |
|---|---|---|---|---|
| ADR | yes/no | yes/no | yes/no | QUALITY-OK / QUALITY-UNCERTAIN |
| TST | yes/no | yes/no | yes/no | QUALITY-OK / QUALITY-UNCERTAIN |

[List any REQUIRES-HUMAN-REVIEW reclassifications here]
