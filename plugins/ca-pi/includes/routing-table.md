...
| New skill needed | `skill-author` skill at `<plugin-root>/routines/skill-author/SKILL.md` (explicit `/new-skill` uses the same owner) | — | No skill until the gap is proven uncovered |
