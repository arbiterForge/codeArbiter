...
the typed-HTML pilot, load `<plugin-root>/includes/artifacts.md` before resume
...
tests from `<plugin-root>/includes/verification-boundary.md` to be green; exhaustive cross-area and
