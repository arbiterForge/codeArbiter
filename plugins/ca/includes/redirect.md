...
```
That reads as <inferred intent> → </ca: command, prefilled with the user's own words>
...
<up to three prefilled /ca: commands, closest first>
...
<up to three prefilled /ca: commands>
...
/ca:init  /ca:status  /ca:metrics  /ca:audit  /ca:preview  /ca:statusline  /ca:prune  /ca:doctor  /ca:standup  /ca:cleanup  /ca:task
