...
Write the surviving docs to `${CLAUDE_PROJECT_DIR}/.codearbiter/`. Every doc carries actual content — no unresolved placeholder may remain where a value was determined:
