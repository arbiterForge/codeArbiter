...
Executed by `tribunal-architecture-reviewer`. Evidence-or-drop on every check.
...
- God modules (>5 imports), over-consumed shared dependencies (>10 consumers, highest priority), monolith accretion in oversized files.
