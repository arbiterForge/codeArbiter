...
`${CLAUDE_PLUGIN_ROOT}/includes/artifacts.md` owns the combined one-reply transaction:
...
Use the private request shape and adapter in `${CLAUDE_PLUGIN_ROOT}/includes/artifacts.md`; a pasted matrix
