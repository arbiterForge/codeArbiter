...
`${CLAUDE_PLUGIN_ROOT}/commands/context-check.md`. The audit begins read-only; re-scout or re-baseline may
...
2. **Pipelines** — every slug in `${CLAUDE_PROJECT_DIR}/.codearbiter/specs/` and `plans/`. Select the
