...
2. Route to `dispatching-parallel-agents` (`${CLAUDE_PLUGIN_ROOT}/skills/dispatching-parallel-agents/SKILL.md`) with that unit list (read-only batch). It dedupes, then
