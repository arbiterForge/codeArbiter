...
Per `${CLAUDE_PLUGIN_ROOT}/includes/reviewer-contract.md`, plus a `**Control:**` line — the control ID or section from `${CLAUDE_PROJECT_DIR}/.codearbiter/security-controls.md`.
