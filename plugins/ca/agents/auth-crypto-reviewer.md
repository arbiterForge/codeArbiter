...
Per `${CLAUDE_PLUGIN_ROOT}/includes/reviewer-contract.md`, plus a `**Control:**` line — the section from `${CLAUDE_PROJECT_DIR}/.codearbiter/security-controls.md`. Name the algorithm, the function, the value in the description.
