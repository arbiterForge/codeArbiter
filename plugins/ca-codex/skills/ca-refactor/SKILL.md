...
- Persisting an already-completed refactor belongs to the existing commit owner at
  [routines/commit-gate/SKILL.md](../../routines/commit-gate/SKILL.md), with its actual authorization and gates.
