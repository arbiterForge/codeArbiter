...
- Recording an already-made new ADR, or inspecting ADR health without arbitration,
  belongs to [routines/decision-lifecycle/SKILL.md](../../routines/decision-lifecycle/SKILL.md). Load that owner
...
[routines/decision-variance/references/analysis.md](../../routines/decision-variance/references/analysis.md) once. It owns
...
[includes/smarts/decision-log-format.md](../../includes/smarts/decision-log-format.md). Capture each choice
...
- **Supersede**: append the explicit replacement decision with the prior log ID in
  ...
  [routines/decision-lifecycle/SKILL.md](../../routines/decision-lifecycle/SKILL.md), with that user's decision,
...
`decision-challenger` ([agents/decision-challenger.md](../../agents/decision-challenger.md)) remains
