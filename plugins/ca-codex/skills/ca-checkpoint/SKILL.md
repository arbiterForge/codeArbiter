...
2. Route to `dispatching-parallel-agents` ([routines/dispatching-parallel-agents/SKILL.md](../../routines/dispatching-parallel-agents/SKILL.md)) with that unit list (read-only batch). It dedupes, then
