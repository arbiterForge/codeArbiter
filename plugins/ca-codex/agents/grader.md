...
Apply the SMARTS framework per [includes/smarts/core.md](../includes/smarts/core.md) (you have access to it). Follow its hard cell constraints exactly.
...
6. It records the user's decision per the decision-log format in [includes/smarts/decision-log-format.md](../includes/smarts/decision-log-format.md).
