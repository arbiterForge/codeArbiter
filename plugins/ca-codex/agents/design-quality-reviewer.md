...
1. [includes/anti-slop-design/INDEX.md](../includes/anti-slop-design/INDEX.md) — the router and load map.
2. [includes/anti-slop-design/core.md](../includes/anti-slop-design/core.md) — always.
