...
Per [includes/reviewer-contract.md](../includes/reviewer-contract.md), plus a `**Control:**` line — the control ID or section from `<project-root>/.codearbiter/security-controls.md`.
