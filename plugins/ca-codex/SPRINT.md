...
([routines/writing-plans/SKILL.md](routines/writing-plans/SKILL.md)) for the task breakdown at the
...
[includes/artifacts.md](includes/artifacts.md) owns the combined one-reply transaction:
...
Use the private request shape and adapter in [includes/artifacts.md](includes/artifacts.md); a pasted matrix
...
For HTML, load [includes/artifacts.md](includes/artifacts.md) and use the exact current identity,
