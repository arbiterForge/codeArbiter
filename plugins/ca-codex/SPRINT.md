...
`<project-root>/.codearbiter/specs/<sprint-slug>.html` through the installed engine, then to `writing-plans` ([routines/writing-plans/SKILL.md](routines/writing-plans/SKILL.md)) for the task
