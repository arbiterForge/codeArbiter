...
Apply [includes/verification-boundary.md](verification-boundary.md) throughout.
...
4. **Run impact-bounded local suite** — every affected test green; exhaustive and cross-platform proof runs in exact-head hosted CI before merge
