...
- `_cleanuplib.py`: closes 3 blocking and 5 high-severity gaps an independent review found in T-03 as first merged (shared core/pysrc change). See the root `CHANGELOG.md` for full detail.
