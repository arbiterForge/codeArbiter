...
- Recording an already-made new ADR, or inspecting ADR health without arbitration,
  belongs to [routines/decision-lifecycle/SKILL.md](../decision-lifecycle/SKILL.md). Load that owner
...
[routines/decision-variance/references/analysis.md](references/analysis.md) once. It owns
...
- **Supersede**: append the explicit replacement decision with the prior log ID in
  ...
  [routines/decision-lifecycle/SKILL.md](../decision-lifecycle/SKILL.md), with that user's decision,
