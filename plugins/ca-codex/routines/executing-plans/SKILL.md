...
[includes/artifacts.md](../../includes/artifacts.md) before HTML artifact I/O;
...
- The discovered authoritative spec/plan pair. Existing Markdown pairs retain
  ...
  [includes/artifacts.md](../../includes/artifacts.md), retain the exact artifact identities
...
completion. Use the installed reconciliation adapter in [includes/artifacts.md](../../includes/artifacts.md) for the exact task,
...
Invoke `subagent-driven-development` ([routines/subagent-driven-development/SKILL.md](../subagent-driven-development/SKILL.md)) with `scope = [current batch task IDs]`. Pass the plan slug and
