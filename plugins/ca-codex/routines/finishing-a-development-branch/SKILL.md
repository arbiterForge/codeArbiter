...
[skills/ca-watch/SKILL.md](../../skills/ca-watch/SKILL.md) with the remaining arguments, then returns.
...
`--cleanup` loads and follows [routines/post-merge-cleanup/SKILL.md](../post-merge-cleanup/SKILL.md)
