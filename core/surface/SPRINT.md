...
> `{{PROJECT_DIR}}/.codearbiter/open-questions.md` (CONFIRM-05).
...
**Resume first:** if `{{PROJECT_DIR}}/.codearbiter/specs/<sprint-slug>.md` and
...
`{{PROJECT_DIR}}/.codearbiter/specs/<sprint-slug>.md`, then to `writing-plans` (`{{PLUGIN_ROOT}}/skills/writing-plans/SKILL.md`) for the task
breakdown at `{{PROJECT_DIR}}/.codearbiter/plans/<sprint-slug>.md`.
