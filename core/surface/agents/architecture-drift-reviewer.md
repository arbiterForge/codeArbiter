...
- `{{PROJECT_DIR}}/.codearbiter/decisions/decision-log.md` — the ADR index. Start here to enumerate all ADRs.
- `{{PROJECT_DIR}}/.codearbiter/decisions/` — read every ADR with status `accepted`.
