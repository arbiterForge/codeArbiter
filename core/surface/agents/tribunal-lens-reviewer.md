...
- `{{PLUGIN_ROOT}}/skills/tribunal/references/lenses/<lens-slug>.md` — the checklist you execute,
...
- `{{PLUGIN_ROOT}}/skills/tribunal/references/finding-record.md` — the finding/v1 record, the
