...
## Required Reading
- `{{PLUGIN_ROOT}}/skills/tribunal/references/lenses/observability.md` — the checklist and exposure denominator.
- `{{PLUGIN_ROOT}}/skills/tribunal/references/finding-record.md` — the finding/v1 record, write rule, id/dedup conventions.
- `{{PROJECT_DIR}}/.codearbiter/tech-stack.md` — logging/tracing/metrics stack; `inventory.md` in the run dir — the boundary map.
