...
## Required Reading
- `{{PLUGIN_ROOT}}/skills/tribunal/references/lenses/reliability.md` — the checklist and exposure denominator.
- `{{PLUGIN_ROOT}}/skills/tribunal/references/finding-record.md` — the finding/v1 record, write rule, id/dedup conventions.
- `{{PROJECT_DIR}}/.codearbiter/tech-stack.md` — async model and concurrency primitives.
