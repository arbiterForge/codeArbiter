...
## Required Reading
- `{{PLUGIN_ROOT}}/skills/tribunal/references/lenses/test-fidelity.md` — the recipe, severity rule, and exposure denominator.
- `{{PLUGIN_ROOT}}/skills/tribunal/references/finding-record.md` — the finding/v1 record, write rule, id/dedup conventions.
- `{{PROJECT_DIR}}/.codearbiter/tech-stack.md` — mock patterns, fixture/factory conventions, the real producers (serializers, DTOs, queries).
