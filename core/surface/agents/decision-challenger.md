...
1. `{{PROJECT_DIR}}/.codearbiter/decisions/` — the ADRs under review.
2. `{{PROJECT_DIR}}/.codearbiter/decisions/decision-log.md` — the decision index.
3. `{{PLUGIN_ROOT}}/includes/smarts/core.md` — the SMARTS lenses, cell rules, and strength labels.
