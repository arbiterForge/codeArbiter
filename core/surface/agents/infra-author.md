...
1. `{{PROJECT_DIR}}/.codearbiter/tech-stack.md` — IaC tool (OpenTofu, Ansible, Helm, etc.), container runtime, CI/CD system, approved registries
2. `{{PROJECT_DIR}}/.codearbiter/security-controls.md` — security boundaries, approved secrets store, compliance requirements affecting infrastructure
