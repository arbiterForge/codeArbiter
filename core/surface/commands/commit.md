...
The `commit-gate` skill (`{{PLUGIN_ROOT}}/skills/commit-gate/SKILL.md`) — all phases. The skill
...
`{{PLUGIN_ROOT}}/includes/verification-boundary.md` must be green; exhaustive repository and
