...
- `{{PROJECT_DIR}}/.codearbiter/<doc>.md` — <what it provides>. Stop if missing; do not guess.
- `{{PLUGIN_ROOT}}/skills/<other-skill>/SKILL.md` — <only if a sibling skill must clear first>.
- `{{PLUGIN_ROOT}}/agents/<agent>.md` — <only if this skill dispatches an agent>.
...
- Paths: project state -> `{{PROJECT_DIR}}/.codearbiter/<doc>`;
  skills -> `{{PLUGIN_ROOT}}/skills/<name>`;
  agents -> `{{PLUGIN_ROOT}}/agents/<name>.md`.
