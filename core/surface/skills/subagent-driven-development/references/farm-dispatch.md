...
the code, never whether it is *reviewed*. See `{{PLUGIN_ROOT}}/includes/farm.md` for setup.
...
enforces gates and a zero-token anti-gaming guard, and writes to `{{PROJECT_DIR}}/.farm/`:
