...
Apply the shared `{{PLUGIN_ROOT}}/includes/verification-boundary.md`: the slice's narrow RED test and
...
`{{PROJECT_DIR}}/.codearbiter/plans/<slug>.plan.json` and an immutable content-addressed base binding
