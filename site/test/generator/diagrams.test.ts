 ...
 *
 * Asserts the three concept diagrams exist, each carries an in-SVG <title>
 * element (accessibility), and each is referenced by at least one page file
 * under site/src/. Guards against a deleted asset, a stripped title, or an
 * orphaned diagram that no page shows.
 */
