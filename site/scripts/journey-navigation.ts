...
export function buildJourneySidebar(reference: Group[], academy: Group[]): Group[] {
  return [
    ...
    group('Guides', [
      ...
      group('Make a change', [link('Review Specs and Plans', 'guides/review-artifacts'), link('Build a Feature End to End', 'guides/feature-lane'), link('Run an Autonomous Sprint', 'guides/autonomous-sprints'), link('Add a Dependency Safely', 'guides/adding-a-dependency'), link('Record an Architecture Decision', 'guides/recording-adrs')]),
      group('Review and ship', [link('Review and Ship a Change', 'guides/review-and-ship'), link('Review a Change', 'reference/commands/review'), link('Commit', 'reference/commands/commit'), link('Open a Pull Request', 'reference/commands/pr'), link('Release Your Project', 'guides/releasing-a-version')]),
