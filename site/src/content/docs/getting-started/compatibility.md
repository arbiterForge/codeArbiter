...
| **Pi** | 0.80.5 or 0.80.10 (this release line) | `ca-pi` is Git-only: `pi install git:arbiterForge/codeArbiter@ca-pi-v<version>`. Also requires Node.js 22.19+. Requires an affirmative project-trust decision before repository-aware startup. See [Install for Pi](/getting-started/pi/). |
