...
<div class="ca-hero">
  ...
  <div class="ca-hero__install">
    ...
    <div class="ca-hero__install-copy">
      ...
      <p class="ca-hero__install-subtext">Choose Claude Code or Codex — shown here. All three governance hosts, <a href="./getting-started/pi/">including Pi</a>, enforce the same project state.</p>
    </div>
  </div>
