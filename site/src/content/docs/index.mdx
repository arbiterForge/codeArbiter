---
title: Arbitration for Claude Code and Codex Workflows
...
<div class="ca-landing__hero">
  <div class="ca-landing__intro">
    <h1 id="_top" class="ca-landing__title">Arbitration for Claude&nbsp;Code and Codex Workflows</h1>
    <div class="ca-landing__tagline">
      Shared enforcement and project-context parity across Claude Code and Codex.
      Tests, reviews, and security checks are real stops in either host.
    </div>
...
<div class="ca-hero">
  <div class="ca-hero__what">
    Two sibling plugins. One shared project store. Gated lanes for every kind of work.
  </div>
  ...
  <div class="ca-hero__install">
    ...
    <div class="ca-hero__install-copy">
      ...
      <p class="ca-hero__install-subtext">Choose Claude Code or Codex. Both enforce the same project state.</p>
    </div>
  </div>
