...
<ReaderJourney
  ...
  boundary={"Sprint overview, not a promise of host parity. Typed verification and review authority are currently Codex-only. Unsupported host boundaries remain stops."}
  steps={[
  {
