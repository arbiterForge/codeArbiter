...
<ReaderJourney
  ...
  },
  {
    ...
    "artifact": "Approval of the current specification, its plan binding, then approval of the current plan.",
    "review": "Follow the exact typed host prompts. A generic reply does not approve both files; one review package does not mean one approval prompt.",
...
<figure class="ca-diagram">
  <img
    src={`${baseUrl}/diagrams/lane-sprint.svg`}
