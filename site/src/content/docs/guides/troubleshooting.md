...
| Doctor reports an unsupported version | Pi CLI is not 0.84.1 | Upgrade to exact Pi 0.84.1, the only supported version in this release line; see [Compatibility](/getting-started/compatibility/) |
