...
EXPECTED_SUITES = {
    ...
    "test_artifact_authoring.py": {
        ...
        "test_explicit_html_pilot_selects_html_after_capability_probe",
        ...
        "test_full_feature_and_sprint_default_to_markdown_without_writing",
        "test_html_requires_explicit_pilot_without_markdown_fallback",
    ...
    "test_artifact_workflow.py": {
        ...
        "test_execution_surfaces_share_the_disabled_default_format_contract",
